...
function StateManagementChapter() {
  return (
    <>
      ...
      <Section chapter={CHAPTER} section="Constants">
        <TextBlock>
          <ul>
            ...
            <li>
              Resets on every <em>render</em>
            </li>
            <li>
              <em>Non-reactive:</em> does not trigger re-render
            </li>
            <li>
              Used to reuse <em>complex expressions</em>
            </li>
          </ul>
          {/* <Message>
        ...
        <div className="flex flex-col gap-4">
          ...
          <CodeBlock>{exampleConstantsCode}</CodeBlock>
        </div>
      </Section>
      <Section chapter={CHAPTER} section="useRef">
        <TextBlock>
          <ul>
            ...
            <li>
              Resets on every <em>mount</em>
            </li>
            <li>
              <em>Non-reactive:</em> does not trigger re-render
            </li>
            <li>
              Used to reference <em>HTML elements</em> or as{" "}
              <em>instance variable</em>
            </li>
          </ul>
        </TextBlock>
        <div className="flex flex-col gap-4">
          ...
          <CodeBlock>{exampleUseRefCode}</CodeBlock>
        </div>
      </Section>
      <Section chapter={CHAPTER} section="useState">
        <TextBlock>
          <ul>
            ...
            <li>
              <em>Reactive:</em> triggers re-render when changed
            </li>
        ...
        <div className="flex flex-col gap-4">
          ...
          <CodeBlock>{exampleUseStateCode}</CodeBlock>
        </div>
      </Section>
      ...
      <Section chapter={CHAPTER} section={"useContext"}></Section>
      <Section chapter={CHAPTER} section={"LocalStorage"}></Section>
    </>
  );
}
